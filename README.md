...
python main.py --job=inference --model_config=model/contra-t5.json --data_path=data/MultiWOZ_2.4_processed/test.json --output_file=data/MultiWOZ_2.4_processed/contra-t5.json --resume
