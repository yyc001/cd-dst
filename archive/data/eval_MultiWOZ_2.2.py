...
def main(args):
    ...
    in_domain_services = get_service_set(os.path.join(args.data_dir, "schema.json"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="./multiwoz/data/MultiWOZ_2.2")
    parser.add_argument("--prediction_dir",  default="./MultiWOZ_2.2_postprocess/test")
    parser.add_argument("--eval_set",  default="test")
    parser.add_argument("--output_metric_file", default="./MultiWOZ_2.2_postprocess/dummy_score")
